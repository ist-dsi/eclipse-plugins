...
public class UpdateWebFragmentParticipant
    extends MojoExecutionBuildParticipant
{

    public UpdateWebFragmentParticipant( MojoExecution execution )
    {
	...
	//        {
	new File("/tmp/didItBennuUWF" + System.currentTimeMillis()).createNewFile();
